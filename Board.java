...
public class Board {
    ...
    // populate the board
    public static ArrayList<Square> makeBoard(CardDeck chanceDeck, CardDeck communityChestDeck) {
        ...
        board.add(new CommunityChest(communityChestDeck));
        ...
        board.add(new Chance(chanceDeck));
